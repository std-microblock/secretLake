...
if (typeof gxz != 'object') {
  console.log("%c GXZV %c Ganxiaozhe Very [Cute]. ", "color: #fff; margin-top: 1em; padding: 5px 0; background: #000; font-weight: 600;", "margin-bottom: 1em; padding: 5px 0; background: #efefef; color: #333");
  console.log("%c 提示 %c 请不要对本站发起任何测压，攻击或恶意脚本。", "color: #fff; margin-top: 1em; padding: 5px 0; background: #ff5029;", "margin-bottom: 1em; padding: 5px 0; background: #efefef; color: #333");
}
...
function navPut () {
  ...
  if (nav.header.length > 0) {
    ...
    nav.header.html('<div class="nav_mText"><span onclick="window.top.location.href=\'/\';"><img src="/img/unitvs-icon-256px.png" style="width:32px;height:32px;vertical-align:middle;margin-top:-5px;"></span></div>' +
      '<nav class="nav"><input type="checkbox" class="nav_cb" id="nav-menu" />' +
      '<div class="nav_content">' +
      '<div class="nav_logo"><a href="/" target="_self"><img src="/img/unitvs-icon-256px.png"></a></div>' +
      nav.user +
      '<ul class="nav_list">' +
      '<li><a class="nav_a" href="/demo/stall/" target="_self">地摊经济</a></li>' +
      '<li><a class="nav_a" href="/demo/drink/" target="_self">餐饮行业</a></li>' +
      '<li><a class="nav_a" href="/qiye/" target="_self">企业解决方案</a></li>' +
      '</ul>' +
      '</div><div class="wrap-btn"><label class="nav_btn" for="nav-menu"></label></div><div class="nav_flex"></div>' +
      '</nav>');
...
function footerPut () {
  ...
  if (footer) {
    ...
    let gxzvery = ['Approachable', 'Amusing', 'Cute', 'Dangerous', 'Exciting', 'Fatigued', 'Important', 'Meticulously', 'Mysterious', 'Riveting', 'Tasteful'];
    ...
    footer.innerHTML = "<div class='footerNav'>" +
      ...
      "<div class='gl-flex btw'><div class='gxz-info'><a href='//www.unitvs.com/' target='_blank'>gxzv.com</a> / <a href='http://beian.miit.gov.cn/' target='_blank'>渝ICP备20007909号-4</a></div><div class='disclaimers'><span>Copyright © 2020 GXZV. All rights reserved./</span><div class='listMap'><a id='gxz-copyright' href='/copyright.html'>法律声明及版权</a> / <a id='gxz-contact-qq' data-gtip='QQ: 630224338'>联系</a> / <a id='gxz-mdf-theme'><i class='gi " + t.icon + "'></i> 主题</a></div></div></div>" +
      "<div class='gl-flex btw'><div class='gxz-info'>" + t.sayT + "</div><div class='disclaimers'>Ganxiaozhe is Very [" + gxz.saying.random(gxzvery, 'both') + "]</div></div>" +
      "</div>" +
      "</div>";
